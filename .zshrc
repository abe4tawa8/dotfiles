...
if [ $(uname) = "Darwin" ]; then
  ...
  alias ll='ls -lv'
  alias la='ls -alv'
  alias mysql_load='launchctl load -w ~/Library/LaunchAgents/com.mysql.mysqld.plist'
  alias mysql_unload='launchctl unload -w ~/Library/LaunchAgents/com.mysql.mysqld.plist'
